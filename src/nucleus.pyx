...
cpdef dict make_eval_images(cnp.ndarray[DTYPE_t, ndim=2] ans_img, cnp.ndarray[DTYPE_t, ndim=2] bf_img, float care_rate=75, float lower_ratio=17, float heigher_ratio=0):
    """
    評価用画像を作成する関数
